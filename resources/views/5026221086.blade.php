...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/linktreestyles.css') }}" />
    <link
  ...
  <body>
    <div class="darrellv-container">
      <div class="darrellv-sharebutton">
        <img src="{{ asset('img/threedots.svg') }}"/>
      </div>
      <div class="darrellv-image-container">
        <img class="darrellv-logo" src="{{ asset('img/logo.jpeg') }}" alt="Logo Solaria" />
        <h1>Mr Suprek</h1>
        <h2>Makan Enak Tetap Ngirit ! #MakanSuprekTiapHari 📍12 Jawa Timur📍3 <br> Kalimantan</h2>
      </div>

      <div class="darrellv-links-container">
        <div class="darrellv-links">
          <img class="darrellv-icons" src="{{ asset('img/icons8-whatsapp.svg') }}" />
          <a href="https://api.whatsapp.com/message/CAHV3BNUARKGL1?autoload=1&app_absent=0" target="_blank">
            <p>Whatsapp (Pemesanan dan Komplain)</p>
          </a>
          <div class="darrellv-dots">
            <h3>...</h3>
          </div>
        </div>
      </div>
      ...
      <div class="darrellv-links-container">
        <div class="darrellv-links">
          <img class="darrellv-icons" src="{{ asset('img/grab.webp') }}" />
          <a href="https://linktr.ee/MrSuprekGrabFood" target="_blank">
            <p>Pesan Melalui Grab Food</p>
          </a>
          <div class="darrellv-dots">
            <h3>...</h3>
          </div>
      ...
      <div class="darrellv-links-container">
        <div class="darrellv-links">
          <img class="darrellv-icons" src="{{ asset('img/gofood.webp') }}" />
          <a href="https://linktr.ee/MrSuprekGoFood" target="_blank">
            <p>Pesan Melalui Go Food</p>
          </a>
          <div class="darrellv-dots">
            <h3>...</h3>
          </div>
      ...
      <div class="darrellv-links-container">
        <div class="darrellv-links">
          <img class="darrellv-icons" src="{{ asset('img/shopee.webp') }}" />
          <a href="https://linktr.ee/MrSuprekShopeeFood" target="_blank">
            <p>Pesan Melalui Shopee Food</p>
          </a>
          <div class="darrellv-dots">
            <h3>...</h3>
          </div>
      ...
      <div class="darrellv-links-container">
        <div class="darrellv-links">
          <img class="darrellv-icons" src="{{ asset('img/maps.svg') }}" />
          <a href="https://goo.gl/maps/SZmv6DbkCpk7wJi3A" target="_blank">
            <p>Alamat Mr Suprek - Kedungdoro</p>
          </a>
          <div class="darrellv-dots">
            <h3>...</h3>
          </div>
      ...
      <div class="darrellv-links-container">
        <div class="darrellv-links">
          <img class="darrellv-icons" src="{{ asset('img/maps.svg') }}" />
          <a href="https://goo.gl/maps/a8StVpDLzgo54XoK7" target="_blank">
            <p>Alamat Mr Suprek - Koni</p>
          </a>
          <div class="darrellv-dots">
            <h3>...</h3>
          </div>
      ...
      <div class="darrellv-links-container">
        <div class="darrellv-links">
          <img class="darrellv-icons" src="{{ asset('img/maps.svg') }}" />
          <a href="https://goo.gl/maps/G97nr3CSj8dW9r4b9" target="_blank">
            <p>Alamat Mr Suprek - Keputih</p>
          </a>
          <div class="darrellv-dots">
            <h3>...</h3>
          </div>
    ...
    <div class="darrellv-socialmedia">
      <img class="darrellv-image" src="{{ asset('img/icons8-instagram.svg') }}" alt="">
      <img class="darrellv-image" src="{{ asset('img/icons8-whatsapp2.svg') }}" alt="">
    </div>

    <!-- Menggunakan SVG Asli Linktree -->
    <div class="darrellv-linktree">
      <a
        href="https://linktr.ee/mrsuprek"
        ><svg
          height="100%"
          viewBox="0 0 80 17"
